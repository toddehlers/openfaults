...
head('Google Analytics Notice'); 

if (isset($_GET['out']))
	echo '<span style="color: green;"><strong>You are not beeing tracked.</strong></span><br /><br />';
...
<br /><p>You can refuse the use of Google Analytics by clicking on the following link. An opt-out cookie will be set on the computer, which prevents the future collection of your data when visiting this website: <a href="trackinginfo.php?out=1" onclick="gaOptout();">Disable Google Analytics</a> </p>

<br /><p>Further information concerning the terms and conditions of use and data privacy can be found at <a href="http://www.google.com/analytics/terms/gb.html">http://www.google.com/analytics/terms/gb.html</a> or at <a href="https://www.google.de/intl/en_uk/policies/">https://www.google.de/intl/en_uk/policies/</a>. Please note that on this website, Google Analytics code is supplemented by “anonymizeIp” to ensure an anonymized collection of IP addresses (so called IP-masking).</p>
